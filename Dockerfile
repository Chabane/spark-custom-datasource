...
CMD ["bin/spark-submit", "--class", "Application", "--master", "local[2]", "/usr/local/project/target/spark-custom-datasource-0.1.0-jar-with-dependencies.jar", "/usr/local/project/csv" ]
